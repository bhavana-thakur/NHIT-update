...
{creator_designation}''';
  ...
  void _previewLetter() {
    if (!_formKey.currentState!.validate()) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Please fill in required fields to preview the letter.'),
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Text('Payment Reference: ${_paymentReferenceController.text.trim()}', style: theme.textTheme.bodyMedium),
  ...
  Future<void> _createLetter() async {
    ...
    try {
      final success = await _bankLetterController.createPaymentLetter(
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(success ? 'Payment letter created successfully' : 'Failed to create payment letter'),
